...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {isAdmin && (
        <div className="fixed right-3 top-3 z-[100] flex items-center gap-1 rounded-full border bg-background/95 p-1 shadow-lg backdrop-blur">
          <span className="hidden px-2 text-xs font-semibold text-secondary sm:inline-flex">
